...
public class TripDTO {
    @ApiModelProperty(notes = "Code of the trip. Note that combination of (seasonCode,tripCode) has to be unique",example = "tripCode1")
    private String code;
    @ApiModelProperty(notes = "Code of the season. Note that combination of (seasonCode,tripCode) has to be unique",example = "seasonCode1")
